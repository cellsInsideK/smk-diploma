...
const SearchResults = ({ isSearchFetching, searchedPosts }: SearchResultProps) => {
  if (isSearchFetching) {
    ...
    return <p className="text-light-4 mt-10 text-center w-full">Не найдено</p>;
  }
};
  ...
  return (
    <div className="explore-container">
      <div className="explore-inner_container">
        <h2 className="h3-bold md:h2-bold w-full">Найти посты</h2>
      ...
      <div className="flex-between w-full max-w-5xl mt-16 mb-7">
        <h3 className="body-bold md:h3-bold">Все посты</h3>
